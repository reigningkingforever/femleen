...
<html lang="en">
  <head>
    <title>Femleen Private School</title>
    <meta charset="utf-8">
  ...
  <body>
	    		...
	    		<div class="col-lg-12 d-block">
		    		<div class="row d-flex">
			    		<div class="col-md-6 pr-4 d-flex topper align-items-center">
						    ...
						    <span class="text">1, Kazeem Arulogun Street, off up-chealsea b/stop Erunwen IKD, Lagos</span>
					    </div>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-3 d-flex align-items-center">
						<p class="mb-0"><a href="#" class="btn btn-secondary px-4 py-3">Register your Child</a></p>
					</div>
				</div>
			</div>
		</section>
    ...
    <section class="ftco-section">
    	<div class="container">
    		<div class="row justify-content-center mb-5 pb-2">
          <div class="col-md-8 text-center heading-section ftco-animate">
            <h2 class="mb-4"><span>Our</span> Tuition</h2>
            <p>Separated they live in. A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country</p>
          </div>
        </div>
    		<div class="row">
        	<div class="col-md-6 col-lg-3 ftco-animate">
        		<div class="pricing-entry bg-light pb-4 text-center">
        			<div>
	        			...
	        			<p><span class="price">$24.50</span> <span class="per">/ term</span></p>
	        		</div>
	        		<div class="img" style="background-image: url('{{ asset("frontend/images/bg_1.jpg") }}');"></div>
	        		<div class="px-4">
	        			<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
        			</div>
        			<p class="button text-center"><a href="#" class="btn btn-primary px-4 py-3">Register Now</a></p>
        		</div>
        	</div>
        	<div class="col-md-6 col-lg-3 ftco-animate">
        		<div class="pricing-entry bg-light pb-4 text-center">
        			<div>
	        			...
	        			<p><span class="price">$34.50</span> <span class="per">/ term</span></p>
	        		</div>
	        		<div class="img" style="background-image: url('{{ asset("frontend/images/bg_2.jpg") }}');"></div>
        			<div class="px-4">
	        			<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
        			</div>
        			<p class="button text-center"><a href="#" class="btn btn-secondary px-4 py-3">Register Now</a></p>
        		</div>
        	</div>
        	<div class="col-md-6 col-lg-3 ftco-animate">
        		<div class="pricing-entry bg-light active pb-4 text-center">
        			<div>
	        			...
	        			<p><span class="price">$54.50</span> <span class="per">/ term</span></p>
	        		</div>
	        		<div class="img" style="background-image: url('{{ asset("frontend/images/bg_3.jpg") }}');"></div>
        			<div class="px-4">
	        			<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
        			</div>
        			<p class="button text-center"><a href="#" class="btn btn-tertiary px-4 py-3">Register Now</a></p>
        		</div>
        	</div>
        	<div class="col-md-6 col-lg-3 ftco-animate">
        		<div class="pricing-entry bg-light pb-4 text-center">
        			<div>
	        			...
	        			<p><span class="price">$89.50</span> <span class="per">/ term</span></p>
	        		</div>
	        		<div class="img" style="background-image: url('{{ asset("frontend/images/bg_5.jpg") }}');"></div>
        			<div class="px-4">
	        			<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
        			</div>
        			<p class="button text-center"><a href="#" class="btn btn-quarternary px-4 py-3">Register Now</a></p>
        		</div>
        	</div>
        </div>
    	</div>
          ...
          <div class="col-md-6 col-lg-3">
            <div class="ftco-footer-widget mb-5">
              ...
              <div class="block-21 mb-5 d-flex">
                <a class="blog-img mr-4" style="background-image: url('{{ asset("frontend/images/image_2.j  pg") }}');"></a>
                <div class="text">
                  <h3 class="heading"><a href="#">Even the all-powerful Pointing has no control about</a></h3>
                  <div class="meta">
                    <div><a href="#"><span class="icon-calendar"></span> Dec 25, 2018</a></div>
